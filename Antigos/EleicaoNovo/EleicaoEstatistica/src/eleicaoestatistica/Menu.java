...
public class Menu {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(Opc!=9){
            ...
            switch(Opc){
                case 1: votacao = m.CadEleitor(eleitor);
                    break;
                case 2:
                    CadVotacao12(votacao);
                    break;
                case 3:
                    votacao = m.AgruparEleitor(eleitor);
                    break;
    ...
    private static void CadVotacao12(Votacao[] votacao) {
        ...
        Metodos m = new Metodos();
        while(Opc!=9){
            JOptionPane.showInputDialog("Cadastro Votação 1,2 \n 1- Cadastro Votação 1 \n 2 - Cadastro Votação 2\n 9 - FIM");
            switch(Opc){
                case 1:
                    votacao = m.FCadVotacao(votacao);
                    break;
                case 3: votacao = m.FCadVotacao(votacao);
                    break;
                case 9:
                    JOptionPane.showMessageDialog(null," Finalizado");
                    break;
